namespace Tichu.Presentation.Shell
{
    ...
    public static class AppFlowReducer
    {
        public static ScreenState Reduce(ScreenState current, AppFlowEvent evt) => (current, evt) switch
        {
            ...
            (ScreenState.ModeSelect,       AppFlowEvent.OpenDifficultySelect) => ScreenState.DifficultySelect,
            (ScreenState.DifficultySelect, AppFlowEvent.StartAiMatch)         => ScreenState.InGame,
            (ScreenState.DifficultySelect, AppFlowEvent.Back)                 => ScreenState.ModeSelect,
